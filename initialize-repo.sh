...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-e1run1
echo     https://github.com/tfynes-pivotal/tap-gitops-e1run1
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-e1run1 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-e1run1
git branch -M main
